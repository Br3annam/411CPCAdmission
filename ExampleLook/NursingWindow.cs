...
namespace ExampleLook
{
    public partial class NursingWindow : Form
    {
        ...
        private void setNursing()
        {
            ...
            dl.yesFullAssess = yesFullAssessComboBox.SelectedIndex.ToString();
            dl.currentReportPain = currentReportPainComboBox.SelectedIndex.ToString();
            dl.spiritReligCultPrac = spiritReligCultPracComboBox.SelectedIndex.ToString();
            dl.canPatWrite = canPatWriteComboBox.SelectedIndex.ToString();
            dl.canPatRead = canPatReadComboBox.SelectedIndex.ToString();
            dl.concernReturnRes = concernReturnResComboBox.SelectedIndex.ToString();
            dl.bMIAgreeAssess = bMIAgreeAssessComboBox.SelectedIndex.ToString();
            dl.fluidIntake = fluidIntakeComboBox.SelectedIndex.ToString();
            dl.histSexAbuse = histSexAbuseComboBox.SelectedIndex.ToString();
            dl.closeAttemptSuicide = closeAttemptSuicideComboBox.SelectedIndex.ToString();
            dl.diagSchiz = diagSchizComboBox.SelectedIndex.ToString();
            dl.attemptAroundPpl = attemptAroundPplComboBox.SelectedIndex.ToString();
            dl.stoppedAttempt = stoppedAttemptComboBox.SelectedIndex.ToString();
            dl.madeSuicideAttempt = madeSuicideAttemptComboBox.SelectedIndex.ToString();
            dl.haveOwnLethal = haveOwnLethalComboBox.SelectedIndex.ToString();
            dl.thoughtsFrighten = thoughtsFrightenComboBox.SelectedIndex.ToString();
            dl.thinkActThoughts = thinkActThoughtsComboBox.SelectedIndex.ToString();
            dl.workedOutKillSelf = workedOutKillSelfComboBox.SelectedIndex.ToString();
            dl.thoughtKillSelfHow = thoughtKillSelfHowComboBox.SelectedIndex.ToString();
            dl.thoughtKillsSelfIntent = thoughtKillsSelfIntentComboBox.SelectedIndex.ToString();
            dl.thoughtKillSelf = thoughtKillSelfComboBox.SelectedIndex.ToString();
            dl.wishDead = wishDeadComboBox.SelectedIndex.ToString();
            dl.appearSelfInf = appearSelfInfComboBox.SelectedIndex.ToString();
            dl.presentSelfInj = presentSelfInjComboBox.SelectedIndex.ToString();
            dl.withdrawnLately = withdrawnLatelyComboBox.SelectedIndex.ToString();
            dl.hopelessHelpless = hopelessHelplessComboBox.SelectedIndex.ToString();
            dl.highLevelStress = highLevelStressComboBox.SelectedIndex.ToString();
            dl.intentHurtUpset = intentHurtUpsetComboBox.SelectedIndex.ToString();
            dl.histSubAbuse = histSubAbuseComboBox.SelectedIndex.ToString();
            dl.seekStafRad = seekStafRadComboBox.SelectedIndex.ToString();
            dl.talkLovedOutRad = talkLovedOutRadComboBox.SelectedIndex.ToString();
            dl.activeDistractRad = activeDistractRadComboBox.SelectedIndex.ToString();
            dl.internalCopeRad = internalCopeRadComboBox.SelectedIndex.ToString();
            dl.riskStateRad = riskStateRadComboBox.SelectedIndex.ToString();
            dl.riskStatusRad = riskStatusRadComboBox.SelectedIndex.ToString();
            dl.berCat3ConsultReq = berCat3ConsultReqComboBox.SelectedIndex.ToString();
            dl.berCat3Risk = berCat3RiskComboBox.SelectedIndex.ToString();
            dl.berCat3Result = berCat3ResultComboBox.SelectedIndex.ToString();
            dl.berCat2Result = berCat2ResultComboBox.SelectedIndex.ToString();
            dl.berCat1Result = berCat1ResultComboBox.SelectedIndex.ToString();
            dl.berNodOffDriveOften = berNodOffDriveOftenComboBox.SelectedIndex.ToString();
            dl.berNodOffDrive = berNodOffDriveComboBox.SelectedIndex.ToString();
            dl.berWalkTired = berWalkTiredComboBox.SelectedIndex.ToString();
            dl.berOftenTired = berOftenTiredComboBox.SelectedIndex.ToString();
            dl.berHighBP = berHighBPComboBox.SelectedIndex.ToString();
            dl.berNoticeQuitBreath = berNoticeQuitBreathComboBox.SelectedIndex.ToString();
            dl.berSnoreBotherPeople = berSnoreBotherPeopleComboBox.SelectedIndex.ToString();
            dl.berOftenSnore = berOftenSnoreComboBox.SelectedIndex.ToString();
            dl.berSnoreIs = berSnoreIsComboBox.SelectedIndex.ToString();
            dl.berDoSnore = berDoSnoreComboBox.SelectedIndex.ToString();
            dl.gender = genderComboBox.SelectedIndex.ToString();
            dl.yesPhysNotified = yesPhysNotifiedComboBox.SelectedIndex.ToString();
            dl.offTobCess = offTobCessComboBox.SelectedIndex.ToString();
            dl.usedTobaccoL30 = usedTobaccoL30ComboBox.SelectedIndex.ToString();
            dl.tobaccoOtherValue = tobaccoOtherValueComboBox.SelectedIndex.ToString();
            dl.chewValue = chewValueComboBox.SelectedIndex.ToString();
            dl.pipeSmokeValue = pipeSmokeValueComboBox.SelectedIndex.ToString();
            dl.cigarsValue = cigarsValueComboBox.SelectedIndex.ToString();
            dl.cigarettesValue = cigarettesValueComboBox.SelectedIndex.ToString();
            dl.histDevDelay = histDevDelayComboBox.SelectedIndex.ToString();
            dl.birthDefects = birthDefectsComboBox.SelectedIndex.ToString();
            dl.immuneUpToDate = immuneUpToDateComboBox.SelectedIndex.ToString();
            dl.patientAwayHome = patientAwayHomeComboBox.SelectedIndex.ToString();
        }
        ...
        private void getNursing()
        {
            ...
            yesFullAssessComboBox.SelectedIndex = int.Parse(dl.yesFullAssess);
            currentReportPainComboBox.SelectedIndex = int.Parse(dl.currentReportPain);
            spiritReligCultPracComboBox.SelectedIndex = int.Parse(dl.spiritReligCultPrac);
            canPatWriteComboBox.SelectedIndex = int.Parse(dl.canPatWrite);
            canPatReadComboBox.SelectedIndex = int.Parse(dl.canPatRead);
            concernReturnResComboBox.SelectedIndex = int.Parse(dl.concernReturnRes);
            bMIAgreeAssessComboBox.SelectedIndex = int.Parse(dl.bMIAgreeAssess);
            fluidIntakeComboBox.SelectedIndex = int.Parse(dl.fluidIntake);
            histSexAbuseComboBox.SelectedIndex = int.Parse(dl.histSexAbuse);
            closeAttemptSuicideComboBox.SelectedIndex = int.Parse(dl.closeAttemptSuicide);
            diagSchizComboBox.SelectedIndex = int.Parse(dl.diagSchiz);
            attemptAroundPplComboBox.SelectedIndex = int.Parse(dl.attemptAroundPpl);
            stoppedAttemptComboBox.SelectedIndex = int.Parse(dl.stoppedAttempt);
            madeSuicideAttemptComboBox.SelectedIndex = int.Parse(dl.madeSuicideAttempt);
            haveOwnLethalComboBox.SelectedIndex = int.Parse(dl.haveOwnLethal);
            thoughtsFrightenComboBox.SelectedIndex = int.Parse(dl.thoughtsFrighten);
            thinkActThoughtsComboBox.SelectedIndex = int.Parse(dl.thinkActThoughts);
            workedOutKillSelfComboBox.SelectedIndex = int.Parse(dl.workedOutKillSelf);
            thoughtKillSelfHowComboBox.SelectedIndex = int.Parse(dl.thoughtKillSelfHow);
            thoughtKillsSelfIntentComboBox.SelectedIndex = int.Parse(dl.thoughtKillsSelfIntent);
            thoughtKillSelfComboBox.SelectedIndex = int.Parse(dl.thoughtKillSelf);
            wishDeadComboBox.SelectedIndex = int.Parse(dl.wishDead);
            appearSelfInfComboBox.SelectedIndex = int.Parse(dl.appearSelfInf);
            presentSelfInjComboBox.SelectedIndex = int.Parse(dl.presentSelfInj);
            withdrawnLatelyComboBox.SelectedIndex = int.Parse(dl.withdrawnLately);
            hopelessHelplessComboBox.SelectedIndex = int.Parse(dl.hopelessHelpless);
            highLevelStressComboBox.SelectedIndex = int.Parse(dl.highLevelStress);
            intentHurtUpsetComboBox.SelectedIndex = int.Parse(dl.intentHurtUpset);
            histSubAbuseComboBox.SelectedIndex = int.Parse(dl.histSubAbuse);
            seekStafRadComboBox.SelectedIndex = int.Parse(dl.seekStafRad);
            talkLovedOutRadComboBox.SelectedIndex = int.Parse(dl.talkLovedOutRad);
            activeDistractRadComboBox.SelectedIndex = int.Parse(dl.activeDistractRad);
            internalCopeRadComboBox.SelectedIndex = int.Parse(dl.internalCopeRad);
            riskStateRadComboBox.SelectedIndex = int.Parse(dl.riskStateRad);
            riskStatusRadComboBox.SelectedIndex = int.Parse(dl.riskStatusRad);
            berCat3ConsultReqComboBox.SelectedIndex = int.Parse(dl.berCat3ConsultReq);
            berCat3RiskComboBox.SelectedIndex = int.Parse(dl.berCat3Risk);
            berCat3ResultComboBox.SelectedIndex = int.Parse(dl.berCat3Result);
            berCat2ResultComboBox.SelectedIndex = int.Parse(dl.berCat2Result);
            berCat1ResultComboBox.SelectedIndex = int.Parse(dl.berCat1Result);
            berNodOffDriveOftenComboBox.SelectedIndex = int.Parse(dl.berNodOffDriveOften);
            berNodOffDriveComboBox.SelectedIndex = int.Parse(dl.berNodOffDrive);
            berWalkTiredComboBox.SelectedIndex = int.Parse(dl.berWalkTired);
            berOftenTiredComboBox.SelectedIndex = int.Parse(dl.berOftenTired);
            berHighBPComboBox.SelectedIndex = int.Parse(dl.berHighBP);
            berNoticeQuitBreathComboBox.SelectedIndex = int.Parse(dl.berNoticeQuitBreath);
            berSnoreBotherPeopleComboBox.SelectedIndex = int.Parse(dl.berSnoreBotherPeople);
            berOftenSnoreComboBox.SelectedIndex = int.Parse(dl.berOftenSnore);
            berSnoreIsComboBox.SelectedIndex = int.Parse(dl.berSnoreIs);
            berDoSnoreComboBox.SelectedIndex = int.Parse(dl.berDoSnore);
            genderComboBox.SelectedIndex = int.Parse(dl.gender);
            yesPhysNotifiedComboBox.SelectedIndex = int.Parse(dl.yesPhysNotified);
            offTobCessComboBox.SelectedIndex = int.Parse(dl.offTobCess);
            usedTobaccoL30ComboBox.SelectedIndex = int.Parse(dl.usedTobaccoL30);
            tobaccoOtherValueComboBox.SelectedIndex = int.Parse(dl.tobaccoOtherValue);
            chewValueComboBox.SelectedIndex = int.Parse(dl.chewValue);
            pipeSmokeValueComboBox.SelectedIndex = int.Parse(dl.pipeSmokeValue);
            cigarsValueComboBox.SelectedIndex = int.Parse(dl.cigarsValue);
            cigarettesValueComboBox.SelectedIndex = int.Parse(dl.cigarettesValue);
            histDevDelayComboBox.SelectedIndex = int.Parse(dl.histDevDelay);
            birthDefectsComboBox.SelectedIndex = int.Parse(dl.birthDefects);
            immuneUpToDateComboBox.SelectedIndex = int.Parse(dl.immuneUpToDate);
            patientAwayHomeComboBox.SelectedIndex = int.Parse(dl.patientAwayHome);
        }
